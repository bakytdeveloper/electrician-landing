...
const Modal = ({ isOpen, onClose, type = 'callback' }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSubmitStatus({
                type: 'success',
                message: response.data.message || '✅ Заявка успешно отправлена! Мы свяжемся с вами.'
            });
            ...
            setSubmitStatus({
                type: 'error',
                message: error.response?.data?.message || '❌ Ошибка при отправке формы. Пожалуйста, попробуйте позже или позвоните нам.'
            });
        } finally {
            setIsLoading(false);
        }
                        ...
                        <>
                            ...
                            <div className="form-group">
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows="4"
                                    placeholder={`Опишите вашу проблему или задайте вопрос... (${city})`}
                                />
                            </div>
                        </>
                    )}
