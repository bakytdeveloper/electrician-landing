            ...
            <div className="editor-tabs-content">
                ...
                {activeTab === 'general' && (
                    <div className="editor-section">
                        ...
                        {/* ОДНО поле для текста вместо двух */}
                        <div className="form-group">
                            <label>Основной текст (параграф)</label>
                            <textarea
                                value={content.greetingText}
                                onChange={(e) => setContent({ ...content, greetingText: e.target.value })}
                                rows="12"
                                className="greeting-textarea"
                                placeholder="Введите текст с переносами строк. Для создания нового абзаца просто нажмите Enter дважды."
                            />
                            <small className="form-hint">
                                💡 Поддерживаются переносы строк. Чтобы создать новый абзац, нажмите Enter дважды.
                                Весь текст будет отображаться с сохранением форматирования.
                            </small>
                        </div>
                    </div>
                )}
